...
export default class AddStudent extends Component{
    constructor(props) {
        ...
        this.onChangeUsrRole = this.onChangeUsrRole.bind(this);
    ...
    onSubmit(e) {
        if(this.state.user_password===this.state.user_confirm_password){
            ...
            axios.post('/users/add_student', newUser)
                .then(res=>{
                    alert(res.data)
                }).catch(err=>{
                alert(err)
        ...
        return (
            <div className="login-form" style={{"max-width": "600px"}}>
                <div className={"frm"}>
                    ...
                    <center><h2 className="text-light"> Add Users </h2></center>
                </div>
                <form onSubmit={this.onSubmit}>
                    <dev className={"row"}>
                        ...
                        <dev className={"col-lg"}>
                            ...
                            <div className="form-group">
                                <p className={"txt"}>User Role :</p>
                                <select name="users" className="custom-select form-control" onChange={this.onChangeUsrRole}>
                            ...
                            <div className="form-group">
                                <p className={"txt"}> &nbsp; </p>
                                <button type={"submit"} className={"btn btn-primary btn-block"} style={{"background": "#400000"}}>Add User</button>
                            </div>
                        </dev>
                    </dev>
                </form>
